DROP FUNCTION IF EXISTS sp_create_user(TEXT, TEXT, TEXT, DATE, TEXT, TEXT, TEXT, INT, TEXT);
DROP FUNCTION IF EXISTS sp_update_user(UUID, TEXT, TEXT, TEXT, DATE, TEXT, TEXT, TEXT, INT, TEXT);
